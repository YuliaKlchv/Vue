    ...
    <div class="register" id="register" v-if="(showModal = true)">
      <div class="register-logo">
        ...
        <div class="user-fields">
          ...
          <div>
            <span v-if="msg.password" class="alert1">{{ msg.password }}</span>
          </div>
          <div>
            <input
              name="password"
            ...
            <div>
              ...
              />
              <div>
                <span v-if="msg.email" class="alert1">{{ msg.email }}</span>
              </div>
              <div>
                <span v-if="msg.password_confirm" class="alert1">{{
                  msg.password_confirm
                }}</span>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    validatePassword(value) {
      ...
      if (value.length < 8) {
        this.msg["password"] =
          "Must be min 6 characters! " + difference + " characters left";
